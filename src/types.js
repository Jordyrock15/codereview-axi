 ...
 * @property {string|null|undefined} branch — Branch HEAD was on when the session was opened or last reused, used as the tab's short label. Undefined on sessions written by an older version.
